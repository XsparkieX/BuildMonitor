...
MSBuild.exe "%~dp0..\BuildMonitorServer.vcxproj" /nologo /t:Rebuild /p:Configuration=Release
if %errorlevel% neq 0 (
...
rd /S /Q "%~dp0\Files\"
mkdir "%~dp0\Files\"
copy "%~dp0\..\x64\Release\BuildMonitorServer.exe" "%~dp0\Files\"
"C:\Qt\5.9\msvc2017_64\bin\windeployqt.exe" "%~dp0\Files\BuildMonitorServer.exe"
if %errorlevel% neq 0 (
